...
<?php include 'files/menu.php';
    ...
    $saleinvoQuery = "SELECT  `selldate`, `billchallan`, `customerid`, `productid`, `quantity`, `price`, `weight`, `transport`, `vat`, `discount`, `comission`, `payment_taka`,`token` FROM `sell` WHERE `billchallan`='".$_GET['invo']."' 
                                       UNION
                                       SELECT `return_date`, `memono`, `customerid`, `productid`, `quntity`,`price`, `weight`, `transport`, `vat`, `discount`, `comission`,'0',`token` FROM `sell_return` WHERE `memono`='".$_GET['invo']."'";
                     ...
                     <div class="row">
                        <div class="col-6">
                           <address>
                              ...
                              <?=$dm->getUserFullDetails($invoiceinfo[0]['customerid'])?>
                           </address>
                        </div>
                        <div class="col-6 text-right">
                           <address>
                              ...
                              Invoice create Date :  <?=date("Y-M-d",strtotime($invoiceinfo[0]['selldate']))?>
                           </address>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="">
                              ...
                              <table class="table table-bordered">
                                 ...
                                 <tbody>
                                    <?php 
                                       ...
                                       $i=0;
                                        foreach ($invoiceinfo as $inv) 
                                        {
                                        	...
                                        	$sld =" ";
                                        	$rtrn = " ";
                                       if ($inv['token'] == "s_Cheque" || $inv['token'] == "s_Cash") 
                                           {
                                    ...
                                    <tr>
                                       ...
                                       <td colspan="7" class="text-right"> <strong>Sale Return Extra</strong> </td>
                           ...
                           <div class="d-print-none mo-mt-2">
                              <div class="pull-right">
                                <a href="product-return.php?invoice=<?=$_GET['invo']?>&isEnabled=true&token=sell" class="btn btn-outline-danger waves-effect waves-light">Return <i class="fa fa-minus-square-o"></i></a>
                                 <a href="javascript:window.print()" class="btn btn-outline-success waves-effect waves-light">Print <i class="fa fa-print"></i></a>
                                 <a href="product-sale-edit.php?invo=<?=$_GET['invo']?>" class="btn btn-outline-warning waves-effect waves-light">Edit <i class="fa fa-pencil"></i></a></a>
